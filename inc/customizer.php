...
function iw26_custom_header_and_background() {
	$color_scheme             = iw26_get_color_scheme();
...
function iw26_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => 'default',
			'sanitize_callback' => 'iw26_sanitize_color_scheme',
	...
	$wp_customize->add_control(
		'color_scheme',
		array(
			'label'    => __( 'Base Color Scheme', 'iw26' ),
			'section'  => 'colors',
			'type'     => 'select',
			'choices'  => iw26_get_color_scheme_choices(),
			'priority' => 1,
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'page_background_color',
			array(
				'label'       => __( 'Page Background Color', 'iw26' ),
				'section'     => 'colors',
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'secondary_text_color',
			array(
				'label'       => __( 'Secondary Text Color', 'iw26' ),
				'section'     => 'colors',
			)
		)
	);
 ...
 *
 * Can be filtered with {@see 'iw26_color_schemes'}.
 *
 ...
 */
function iw26_get_color_schemes() {
	/**
...
if ( ! function_exists( 'iw26_get_color_scheme' ) ) :
	/**
	 * Retrieves the current Twenty Sixteen color scheme.
	 *
	 * Create your own iw26_get_color_scheme() function to override in a child theme.
	 *
	 * @since Twenty Sixteen 1.0
	 *
	 * @return array An associative array of either the current or default color scheme HEX values.
	 */
	function iw26_get_color_scheme() {
		$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
		$color_schemes       = iw26_get_color_schemes();
...
endif; // iw26_get_color_scheme

if ( ! function_exists( 'iw26_get_color_scheme_choices' ) ) :
	/**
	 * Retrieves an array of color scheme choices registered for Twenty Sixteen.
	 *
	 * Create your own iw26_get_color_scheme_choices() function to override
	 * in a child theme.
	 *
	 * @since Twenty Sixteen 1.0
	 *
	 ...
	 */
	function iw26_get_color_scheme_choices() {
		$color_schemes                = iw26_get_color_schemes();
...
endif; // iw26_get_color_scheme_choices


if ( ! function_exists( 'iw26_sanitize_color_scheme' ) ) :
	/**
	 * Handles sanitization for Twenty Sixteen color schemes.
	 *
	 * Create your own iw26_sanitize_color_scheme() function to override
	 * in a child theme.
	 *
	 * @since Twenty Sixteen 1.0
	 *
	 ...
	 */
	function iw26_sanitize_color_scheme( $value ) {
		$color_schemes = iw26_get_color_scheme_choices();
...
endif; // iw26_sanitize_color_scheme
 ...
 */
function iw26_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	...
	$color_textcolor_rgb = iw26_hex2rgb( $color_scheme[3] );
	...
	$color_scheme_css = iw26_get_color_scheme_css( $colors );

	wp_add_inline_style( 'iw26-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'iw26_color_scheme_css' );
 ...
 */
function iw26_get_color_scheme_css( $colors ) {
 ...
 * @since Twenty Sixteen 1.0
 */
function iw26_color_scheme_css_template() {
	$colors = array(
	...
	?>
	<script type="text/html" id="tmpl-iw26-color-scheme">
		<?php echo iw26_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'iw26_color_scheme_css_template' );
 ...
 * @see wp_add_inline_style()
 */
function iw26_page_background_color_css() {
	$color_scheme          = iw26_get_color_scheme();
	...
	wp_add_inline_style( 'iw26-style', sprintf( $css, $page_background_color ) );
}
add_action( 'wp_enqueue_scripts', 'iw26_page_background_color_css', 11 );
...
function iw26_link_color_css() {
	...
	wp_add_inline_style( 'iw26-style', sprintf( $css, $link_color ) );
}
add_action( 'wp_enqueue_scripts', 'iw26_link_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function iw26_main_text_color_css() {
	$color_scheme    = iw26_get_color_scheme();
	...
	// Convert main text hex color to rgba.
	$main_text_color_rgb = iw26_hex2rgb( $main_text_color );
	...
	wp_add_inline_style( 'iw26-style', sprintf( $css, $main_text_color, $border_color ) );
}
add_action( 'wp_enqueue_scripts', 'iw26_main_text_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function iw26_secondary_text_color_css() {
	$color_scheme         = iw26_get_color_scheme();
	...
	wp_add_inline_style( 'iw26-style', sprintf( $css, $secondary_text_color ) );
}
add_action( 'wp_enqueue_scripts', 'iw26_secondary_text_color_css', 11 );
